...
const { adminlogin,resetpassword,verifyemail, userlogin, userregister } = require('../controllers/authentication')

const express = require('express');
const { affiliatereferrals, generateaffiliatelink, affiliatesales, affiliatedlinks, affiliatesalesmetrics } = require('../controllers/affiliate');
...
Router.route('/api/affiliate/:courseId/:affiliateId').get(protect, affiliatereferrals)
Router.route('/api/generate-affiliate-link/:courseId').post(protect, generateaffiliatelink)
...
Router.route('/api/affiliate-sales/:affiliateId').get(protect, affiliatesalesmetrics)
