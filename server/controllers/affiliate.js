...
const generateaffiliatelink = async (req, res) => {
    try {
        ...
        const affiliateLink = `https://example.com/course/${courseId}?affiliate=${userId}`;
...
// router.get('/api/affiliate-sales/:affiliateId', async (req, res) => {
//     try {
//         const { affiliateId } = req.params;
//         const affiliate = await Affiliate.findById(affiliateId);

//         if (!affiliate) {
//             return res.status(404).send('Aff
